...
devices_names = {'Blind01' : 'kBLIND01', 'Blind02' : 'kBLIND02', 'Valve01' : 'kVALVE01', 'Valve02' : 'kVALVE02'}
...
def knx_func(event, context):
    ...
    if message['kErrorCode'] == 'CURRENT STATUS':
        ...
        status = {}
        status['BLIND01'] = message['blind01']
        status['BLIND02'] = message['blind02']
        status['VALVE01'] = message['valve01']
        status['VALVE02'] = message['valve02']
        status['kDATE'] = y_m_d
