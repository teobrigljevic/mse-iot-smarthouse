        ...
        beaconManager.setRangingListener(new BeaconManager.BeaconRangingListener() {
            ...
            public void onBeaconsDiscovered(BeaconRegion region, List<Beacon> list) {
                if (!list.isEmpty()) {
                    ...
                    if (nearestBeacon.getMinor()==28809)nearBeaconView.setImageResource(R.mipmap.beacon_rose);
                    if (nearestBeacon.getMinor()==15713)nearBeaconView.setImageResource(R.mipmap.beacon_blue);
                    ...
                    if (list.size()==2) {
                        ...
                        farBeaconInfo.setText("Beacon: " + farBeacon.getMinor() +
                                ...
                                "\nDistance: " + String.format("%.2f",distance))+ "m");
                        if (farBeacon.getMinor()==28809)farBeaconView.setImageResource(R.mipmap.beacon_rose);
                        if (farBeacon.getMinor()==15713)farBeaconView.setImageResource(R.mipmap.beacon_blue);
